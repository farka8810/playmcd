...
// relative path).
//
// The game itself (Merge Archers — Kingdom Defense) runs entirely in the browser;
// the socket is used only to submit a final score and receive live leaderboard
// updates.
...
export const DEFAULT_GAME = 'kingdom-archers';
