...
// reach further, so merging both boosts power and coverage. `sprite` maps to an
// animated Tiny Swords unit in the renderer (idle/attack sheets).
export const CRITTER_LEVELS = [
  null,
  { level: 1, dmg: 8, fireRate: 1.2, range: 320, sprite: 'pawn', name: 'Pawn' },
  { level: 2, dmg: 16, fireRate: 1.4, range: 355, sprite: 'archer', name: 'Archer' },
  { level: 3, dmg: 30, fireRate: 1.6, range: 395, sprite: 'monk', name: 'Monk' },
  { level: 4, dmg: 54, fireRate: 1.8, range: 440, sprite: 'lancer', name: 'Lancer' },
  { level: 5, dmg: 95, fireRate: 2.1, range: 490, sprite: 'warrior', name: 'Warrior' },
  { level: 6, dmg: 165, fireRate: 2.5, range: 560, sprite: 'warrior', name: 'Champion', elite: true },
];
...
// Enemy sprites: animated Tiny Swords "Red" units (run cycle). Normal ones pick
// from the pool; the boss uses the boss sprite (drawn larger). Purely cosmetic.
